 ...
 * В этом классе будет происходить выбор игрока делающего следующий ход, 
 * передача ему "состояния доски",
 * получение обратно "хода", 
 * проверка "хода" на 1) легитимность, 2) условия победы, 
 * вызов отрисовки нового положения "доски"
 * @author Папа Айс
 * 
